...
fn prove_verify() {
    ...
    let result = super::verify2(&proof, &sampled_evaluations, &positions, root, degree_plus_1, &options);
...
fn verify_fail() {
    ...
    let result = super::verify2(&proof, &sampled_evaluations, &positions, root, degree_plus_1 - 1, &options);
